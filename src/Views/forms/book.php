...
<div class="card p-3 my-5 position-relative">
    <button class="btn btn-sm btn-primary position-absolute end-0 top-0" onclick="editForm()">
    ...
    <form action="/books<?= isset($book) ? '/update' : '' ?>" method="POST">
        <div>
            ...
            <div class="row mb-3">
                <div class="col-sm-12 form-value d-none">
                ...
                <div class="col-sm-12 plain-value">
                    <h3><?= $title ?></h3>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <div class="col-sm-4 form-value d-none">
                ...
                <div class="col-sm-2 form-value d-none">
                ...
                <div class="col-sm-3 form-value d-none">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 plain-value">
                    <p><b>Pages:</b> <?= $page_count ?></p>
                </div>

                <div class="col-sm-1 form-value d-none">
